...
\foilhead{\Large 2-1.データセット作成の流れ}
\begin{enumerate}
...
\foilhead{\Large 2-2.動画の保存と連結を行うWebアプリ}
...
\begin{itemize}
	...
	２種類の混同行列を作成すると似たようなものが作成された．
	\vskip\baselineskip %空白行を追加する
	２種類のモデルを動かした結果，外見が似ている車両タイプの正解数は少なく，外見が特徴的なものの正解数は多かった．
	\vskip\baselineskip
